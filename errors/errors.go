...
var (
	...
	ErrCollectionTypeExists       = errors.New("collection type already exists")
	...
	ErrUserHaveAssetAssigned        = errors.New("user has asset assigned")
...
// IsConnectionResetError checks if the error is a connection reset error.
